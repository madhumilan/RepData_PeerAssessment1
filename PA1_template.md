...
1. Loading the dataset and processing it
2. Histogram depicting the total number of steps taken each day
3. Mean and Median of the total steps each day
4. Time series plot of the average number of steps taken
5. The five minute interval which possess the maximum number of steps
6. The code for imputing missing values
7. Histogram of the total steps taken after imputing missing values
8. Panel plot comparing the average number of steps taken every five minute interval across weekdays and weekends
9. R code needed to reproduce the results.


## 1. Loading the dataset and processing it

```{r}
setwd("E:/Data Science Course/R Studio/repdata_data_activity")
...
#Total Steps taken by date - bar chart
...
## 3. Mean and Median of the total steps taken each day
